...
1. Navigate to the ["API Settings"](https://manage.sanity.io/projects/bhy5qzo9/settings/api) page of this Sanity.io project. Then click "Add new token" and create new "write" token.
...
To start editing your site, you can use the Sanity interface at https://remarkable-tiger-63f3d.sanity.studio/.
...
Generated at `2021-01-06T23:37:39.825Z` by Stackbit version `0.3.42`.